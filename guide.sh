...
> node scripts/run-node.mjs -h


🦞 Clawdbot 2026.1.25 (20f6a55) — Your task has been queued; your dignity has been deprecated.
...
Examples:
  ...
  clawdbot message send --target +13522355298 --message "Hi" --json
  ...
  clawdbot agent --to +13522355298 --message "Run summary" --deliver
